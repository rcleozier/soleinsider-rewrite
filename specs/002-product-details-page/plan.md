...
**Performance Goals**: Product detail pages should render DB-backed product data on first load, avoid excessive related-product queries, and keep above-the-fold product imagery optimized.
...
**Scale/Scope**: Two product detail entry routes sharing one detail view, existing product image and vote tables, related carousel of same-brand products within 90 days with fallback releases.
